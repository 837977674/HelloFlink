...
public class WordCountSum {
    public static void main(String[] args) throws Exception {
        ...
        env.addSource(consumer).flatMap(new Tokenizer2()).keyBy(0).timeWindow(Time.seconds(5)).sum(1).print();
...
class Tokenizer2 implements FlatMapFunction<String, Tuple2<String, Integer>> {
